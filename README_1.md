...
## Limitations
Thresholds and weights are illustrative assumptions, not a bank's policy, and are not statistically calibrated (e.g. logistic regression / PD estimation would be a natural next step).
